...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <a class="navbar-brand" href="#"><i>Rodolfo Delgado</i></a>
        ...
        <div class="container mt-4">                 
            <div class="card"> 
                <div class="card-header d-flex">
                    <h2>Detalle</h2>
                    <a href="Controla?accion=MisCompras" class="pt-2 pl-4">Regresar</a>
                </div>   
                <div class="card-body">
                        ...
                        <tbody>
                            <c:forEach var="p" items="${myDetalle}">
                                <tr class="text-center">
                                    ...
                                    <td>                                        
                                        <label><i>${p.producto.nombre}</i></label><br>                                      
                                        <img src="image/${p.producto.foto}" width="80" height="60">
                                    </td>                                                                
                                    <td>${p.getCantidad()}</td>
