        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="Control?menu=Carrito&accion=mostrar"><i class="fas fa-plus-circle"></i> Seguir Comprando</a>
                    </li>                   
                    <li class="nav-item">
                        <a class="nav-link" href="Controla?accion=Carrito">(<label style="color: darkorange">${contador}</label>)<i class="fas fa-cart-plus"></i> Carrito</a>
                    </li>   
                </ul>                                             
                    ...
                    <tbody>
                        <c:forEach var="p" items="${myCompras}">
                            <tr class="text-center">
                                ...
                                <td>${p.getEstado()}</td>                                                                                                       
                                <td>
                                    <a href="Controla?accion=verDetalle&idcompra=${p.getId()}">Ver Detalle</a>
                                </td>                                                                                                       
                            </tr>
                        </c:forEach>
                    </tbody>
