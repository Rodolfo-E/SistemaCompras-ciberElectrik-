...
<%
   ...
   File reportFile = new File(application.getRealPath("/intranet/reportes/rptUsuario.jasper"));
 //  File reportFile = new File(application.getRealPath(raiz+"Control?menu=Usuario&accion=reporte"));
    //parametros
